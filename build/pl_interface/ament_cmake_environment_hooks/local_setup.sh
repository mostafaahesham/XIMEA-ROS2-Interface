...
: ${AMENT_CURRENT_PREFIX:="/home/egsa/EGSA34_PLD/install/pl_interface"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pl_interface/environment/library_path.sh"
