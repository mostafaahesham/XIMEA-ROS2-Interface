...
static const _BusReply_Request_type_support_symbol_names_t _BusReply_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pl_interface, srv, BusReply_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pl_interface, srv, BusReply_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pl_interface, srv, BusReply_Request)() {
  return &::pl_interface::srv::rosidl_typesupport_c::BusReply_Request_message_type_support_handle;
}
...
static const _BusReply_Response_type_support_symbol_names_t _BusReply_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pl_interface, srv, BusReply_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pl_interface, srv, BusReply_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pl_interface, srv, BusReply_Response)() {
  return &::pl_interface::srv::rosidl_typesupport_c::BusReply_Response_message_type_support_handle;
}
...
static const _BusReply_type_support_symbol_names_t _BusReply_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pl_interface, srv, BusReply)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pl_interface, srv, BusReply)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, pl_interface, srv, BusReply)() {
  return &::pl_interface::srv::rosidl_typesupport_c::BusReply_service_type_support_handle;
}
