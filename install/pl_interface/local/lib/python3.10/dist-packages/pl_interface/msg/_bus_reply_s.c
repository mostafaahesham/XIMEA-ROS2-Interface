...
bool pl_interface__msg__bus_reply__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pl_interface.msg._bus_reply.BusReply", full_classname_dest, 36) == 0);
  }
  pl_interface__msg__BusReply * ros_message = _ros_message;
  {  // dest
...
{
  /* NOTE(esteve): Call constructor of BusReply */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("pl_interface.msg._bus_reply");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BusReply");
