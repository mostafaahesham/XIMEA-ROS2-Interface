...
bool pl_interface__msg__bus_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pl_interface.msg._bus_cmd.BusCmd", full_classname_dest, 32) == 0);
  }
  pl_interface__msg__BusCmd * ros_message = _ros_message;
  {  // src
...
{
  /* NOTE(esteve): Call constructor of BusCmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("pl_interface.msg._bus_cmd");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BusCmd");
